...
exports.APP = {
  ...
  FRONT_END_PATH: path.join(__dirname, '../', ''),
};
...
exports.EMAIL = {
  account: argv.email_account || '200359659@qq.com',
  password: argv.email_password || '123456',
  from: '',
  admin: 'sunlh',
};

exports.AKISMET = {
  key: argv.akismet_key || 'you akismet key',
  blog: argv.akismet_blog || 'you akismet blog site.',
};
